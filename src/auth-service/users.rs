// contains logic for creating, storing, retrieving, and deleting users
...
impl Users for UsersImpl {
    ...
    fn create_user(&mut self, username: String, password: String) -> Result<(), String> {
        ...
        let user: User = User { user_uuid: Uuid::new_v4().to_string(), 
    ...
    fn get_user_uuid(&self, username: String, password: String) -> Option<String> {
        // Retrieve User or return None if user can't be found
